...
const EXTRA = [
  ...
  ["Bob Cousy", "Boston Celtics", "PG", 88, 18.4, 5.2, 7.5, 0, 0, 1950, 1963, 924, "1960s"],
  ["Dave Cowens", "Boston Celtics", "C", 86, 17.6, 13.6, 3.8, 1.1, 0.9, 1970, 1983, 766, "1970s"],
  ["Nate Archibald", "Sacramento Kings", "PG", 85, 18.8, 2.3, 7.4, 0, 0, 1970, 1984, 876, "1970s"],
  ["Bob McAdoo", "Los Angeles Lakers", "C", 86, 22.1, 9.4, 2.3, 1.0, 1.5, 1972, 1986, 852, "1970s", "C/PF"],
  ["Wes Unseld", "Washington Wizards", "C", 84, 10.8, 14.0, 3.9, 1.1, 0.6, 1968, 1981, 984, "1970s"],
  ["Earl Monroe", "New York Knicks", "PG", 85, 18.8, 3.0, 3.9, 0, 0, 1967, 1980, 926, "1970s", "PG/SG"],
  ["Bill Walton", "Portland Trail Blazers", "C", 86, 13.3, 10.5, 3.4, 0.8, 2.2, 1974, 1987, 468, "1970s"],
  ["Artis Gilmore", "Chicago Bulls", "C", 84, 17.1, 10.1, 2.0, 0.5, 2.4, 1976, 1988, 909, "1980s"],

  // ---- 1990s additional ----
  ["Tim Hardaway", "Golden State Warriors", "PG", 84, 17.7, 3.3, 8.2, 1.6, 0.1, 1989, 2003, 867, "1990s"],
  ["Chris Mullin", "Golden State Warriors", "SF", 84, 18.2, 4.1, 3.5, 1.6, 0.4, 1985, 2001, 986, "1990s", "SF/SG"],
  ["Glen Rice", "Miami Heat", "SF", 84, 18.3, 4.0, 2.1, 1.0, 0.2, 1989, 2004, 1000, "1990s"],
  ["Mark Price", "Cleveland Cavaliers", "PG", 83, 15.2, 2.6, 6.7, 1.2, 0.1, 1986, 1998, 722, "1990s"],
  ["Dikembe Mutombo", "Denver Nuggets", "C", 85, 9.8, 10.3, 1.0, 0.4, 2.8, 1991, 2009, 1196, "1990s"],
  ["Larry Johnson", "Charlotte Hornets", "PF", 82, 16.2, 7.5, 3.3, 1.0, 0.4, 1991, 2001, 707, "1990s"],
  ["Horace Grant", "Chicago Bulls", "PF", 81, 11.2, 8.1, 2.2, 1.0, 0.9, 1987, 2004, 1165, "1990s", "PF/C"],
  ["Sam Cassell", "Houston Rockets", "PG", 81, 15.7, 3.3, 6.0, 1.2, 0.2, 1993, 2008, 993, "1990s"],
  ["Latrell Sprewell", "New York Knicks", "SG", 82, 18.3, 4.1, 4.0, 1.4, 0.4, 1992, 2005, 913, "1990s"],
  ["Detlef Schrempf", "Seattle SuperSonics", "PF", 82, 13.9, 6.2, 3.4, 1.0, 0.4, 1985, 2001, 1136, "1990s", "PF/SF"],
  ["Mookie Blaylock", "Atlanta Hawks", "PG", 81, 13.5, 3.5, 6.7, 2.3, 0.3, 1989, 2002, 869, "1990s"],

  // ---- 2000s additional ----
  ["Amar'e Stoudemire", "Phoenix Suns", "PF", 85, 18.9, 7.8, 1.2, 0.8, 1.2, 2002, 2016, 846, "2000s", "PF/C"],
  ["Shawn Marion", "Phoenix Suns", "SF", 84, 15.2, 8.7, 1.9, 1.5, 1.1, 1999, 2015, 1163, "2000s", "SF/PF"],
  ["Gilbert Arenas", "Washington Wizards", "PG", 84, 20.7, 3.9, 5.3, 1.6, 0.2, 2001, 2012, 552, "2000s", "PG/SG"],
  ["Rasheed Wallace", "Detroit Pistons", "PF", 83, 14.4, 6.7, 1.8, 1.0, 1.3, 1995, 2013, 1109, "2000s", "PF/C"],
  ["Richard Hamilton", "Detroit Pistons", "SG", 82, 17.1, 3.1, 3.4, 0.9, 0.2, 1999, 2015, 953, "2000s"],
  ["Baron Davis", "LA Clippers", "PG", 83, 16.1, 3.8, 7.2, 1.8, 0.4, 1999, 2012, 835, "2000s"],
  ["Joe Johnson", "Atlanta Hawks", "SG", 83, 16.0, 3.9, 4.0, 0.8, 0.2, 2001, 2018, 1277, "2000s", "SG/SF"],
  ["Carlos Boozer", "Utah Jazz", "PF", 82, 16.2, 9.5, 2.2, 0.9, 0.4, 2002, 2015, 883, "2000s"],
  ["Andre Iguodala", "Philadelphia 76ers", "SF", 83, 11.4, 4.9, 4.2, 1.6, 0.5, 2004, 2023, 1231, "2000s", "SF/SG"],
  ["Deron Williams", "Utah Jazz", "PG", 83, 16.3, 3.1, 8.1, 1.0, 0.2, 2005, 2017, 845, "2000s"],
  ["Josh Smith", "Atlanta Hawks", "PF", 82, 14.5, 7.4, 3.1, 1.3, 1.9, 2004, 2018, 1048, "2000s", "PF/SF"],
  ["Al Jefferson", "Charlotte Hornets", "C", 82, 15.7, 8.4, 1.6, 0.7, 1.1, 2004, 2018, 876, "2000s"],
  ["Jason Terry", "Dallas Mavericks", "SG", 81, 14.4, 2.4, 3.9, 1.2, 0.2, 1999, 2018, 1410, "2000s", "SG/PG"],
  ["Zach Randolph", "Memphis Grizzlies", "PF", 83, 16.6, 9.1, 1.8, 0.7, 0.3, 2001, 2019, 1182, "2010s", "PF/C"],

  // ---- 2010s additional ----
  ["Mike Conley", "Memphis Grizzlies", "PG", 83, 14.9, 3.0, 5.7, 1.3, 0.3, 2007, 2024, 1000, "2010s"],
  ["Al Horford", "Atlanta Hawks", "C", 83, 13.5, 8.0, 3.4, 0.8, 1.1, 2007, 2025, 1100, "2010s", "C/PF"],
  ["Khris Middleton", "Milwaukee Bucks", "SF", 84, 17.5, 5.0, 4.0, 1.2, 0.3, 2012, 2025, 720, "2010s", "SF/SG"],
  ["Andrew Wiggins", "Minnesota Timberwolves", "SF", 82, 19.0, 4.5, 2.4, 1.0, 0.7, 2014, 2025, 750, "2010s"],
  ["Nikola Vucevic", "Orlando Magic", "C", 83, 17.2, 10.6, 3.0, 0.9, 0.8, 2011, 2025, 900, "2010s"],
  ["DeAndre Jordan", "LA Clippers", "C", 81, 9.5, 9.8, 0.9, 0.5, 1.5, 2008, 2025, 1000, "2010s"],
  ["Gordon Hayward", "Utah Jazz", "SF", 82, 15.8, 4.6, 3.6, 1.0, 0.3, 2010, 2024, 750, "2010s", "SF/SG"],
  ["Brook Lopez", "Milwaukee Bucks", "C", 82, 16.0, 5.5, 1.8, 0.6, 1.7, 2008, 2025, 950, "2010s"],
  ["Joakim Noah", "Chicago Bulls", "C", 82, 8.8, 9.0, 2.9, 0.8, 1.2, 2007, 2020, 694, "2010s"],
  ["Luol Deng", "Chicago Bulls", "SF", 81, 14.8, 6.1, 2.4, 1.0, 0.6, 2004, 2019, 1005, "2010s"],
  ["Goran Dragic", "Phoenix Suns", "PG", 81, 13.4, 3.1, 4.7, 1.0, 0.2, 2008, 2023, 856, "2010s"],

  // ---- 2020s additional (current-team depth) ----
  ["Chet Holmgren", "Oklahoma City Thunder", "C", 84, 16.0, 8.0, 2.5, 0.7, 2.3, 2023, 2026, 140, "2020s", "C/PF"],
  ["Brandon Miller", "Charlotte Hornets", "SF", 82, 18.0, 4.5, 3.0, 0.9, 0.7, 2023, 2026, 130, "2020s"],
  ["Devin Vassell", "San Antonio Spurs", "SG", 81, 16.0, 4.0, 3.0, 1.1, 0.4, 2020, 2026, 300, "2020s"],
  ["Trey Murphy", "New Orleans Pelicans", "SF", 81, 15.0, 4.0, 2.5, 1.0, 0.6, 2021, 2026, 250, "2020s"],
  ["Jabari Smith Jr.", "Houston Rockets", "PF", 81, 13.0, 7.5, 1.5, 0.7, 0.9, 2022, 2026, 200, "2020s", "PF/C"],
  ["Keegan Murray", "Sacramento Kings", "SF", 82, 14.0, 6.0, 1.5, 0.9, 0.7, 2022, 2026, 200, "2020s"],
  ["Dyson Daniels", "Atlanta Hawks", "SG", 81, 12.0, 5.5, 4.0, 2.2, 0.5, 2022, 2026, 200, "2020s", "SG/PG"],
  ["RJ Barrett", "Toronto Raptors", "SF", 82, 18.0, 5.0, 3.5, 0.7, 0.3, 2019, 2026, 400, "2020s", "SF/SG"],
  ["Immanuel Quickley", "Toronto Raptors", "PG", 81, 15.0, 3.5, 5.0, 0.9, 0.3, 2020, 2026, 300, "2020s"],
  ["Jalen Suggs", "Orlando Magic", "PG", 81, 13.0, 3.5, 4.0, 1.4, 0.5, 2021, 2026, 250, "2020s", "PG/SG"],
  ["Josh Giddey", "Chicago Bulls", "PG", 81, 14.0, 7.0, 6.0, 0.9, 0.5, 2021, 2026, 300, "2020s", "PG/SF"],
  ["Naz Reid", "Minnesota Timberwolves", "C", 81, 13.0, 5.5, 1.5, 0.8, 0.9, 2019, 2026, 350, "2020s", "C/PF"],
  ["Onyeka Okongwu", "Atlanta Hawks", "C", 80, 11.0, 7.0, 1.5, 0.7, 1.3, 2020, 2026, 300, "2020s"],
  ["Quentin Grimes", "Philadelphia 76ers", "SG", 80, 14.0, 4.0, 3.0, 1.0, 0.3, 2021, 2026, 250, "2020s"],
  ["Herbert Jones", "New Orleans Pelicans", "SF", 81, 11.0, 3.7, 2.6, 1.5, 0.7, 2021, 2026, 280, "2020s", "SF/PF"],
  ["Aaron Gordon", "Denver Nuggets", "PF", 82, 14.5, 6.0, 3.4, 0.8, 0.7, 2014, 2026, 700, "2020s", "PF/SF"],
  ["Michael Porter Jr.", "Denver Nuggets", "SF", 82, 16.5, 7.0, 1.5, 0.7, 0.6, 2018, 2026, 380, "2020s"],
  ["Mikal Bridges", "New York Knicks", "SF", 83, 17.0, 4.0, 3.5, 1.1, 0.5, 2018, 2026, 520, "2020s", "SF/SG"],
  ["Derrick White", "Boston Celtics", "SG", 83, 14.0, 3.8, 4.5, 1.0, 1.0, 2017, 2026, 550, "2020s", "SG/PG"],
];
