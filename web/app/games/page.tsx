...
export const metadata = pageMeta({
  title: "NBA Mini-Games — Hoople, Higher or Lower, Guess the Player & more",
  description: "A vault of free basketball mini-games built on real NBA stats: Hoople, Higher or Lower, Guess the Player, Career Path, Beat the Clock, Score Predictor and the Invincibles squad-builder.",
  path: "/games",
  keywords: ["NBA games", "basketball games", "Hoople NBA", "NBA quiz", "NBA trivia"],
});
    ...
    <div style={{ display: "grid", gap: "1.5rem" }}>
      ...
      <header>
        ...
        <p style={{ color: "var(--muted)", maxWidth: 620, marginTop: 6 }}>
          Free basketball mini-games, all built on real NBA NBA box-score data. Daily puzzles,
