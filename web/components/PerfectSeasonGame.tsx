"use client";
/* =========================================================================
   PERFECT SEASON — the all-time NBA draft game.
   Spin for a random club + era, draft a player into their position, fill your
   side and chase a flawless 82–0. Ported from the original single-file app to
   read the static, build-time NBA box-score data pool and extended with AFL-style
