...
/* Invincibles — a lean squad-builder + Monte-Carlo season simulator. Spin a
   club + season, draft a starting five, then run thousands of 82-game seasons
   to see your win distribution, your odds of going 82–0 and how you rate
      ...
      <div className="card" style={{ padding: "1.25rem", position: "relative" }}>
        ...
        <div style={{ display: "flex", gap: 20, flexWrap: "wrap", alignItems: "baseline" }}>
          ...
          <div style={{ fontSize: ".88rem", color: "var(--muted)", display: "grid", gap: 2 }}>
            ...
            <span>82–0 in <strong style={{ color: "var(--gold)" }}>{result.perfectPct < 0.1 ? "<0.1" : result.perfectPct.toFixed(1)}%</strong> of seasons</span>
            <span>Stronger than <strong style={{ color: "var(--text)" }}>{result.realPercentile}%</strong> of real sides</span>
          </div>
        </div>
        <div style={{ marginTop: 16 }}>
          <div style={{ fontSize: ".72rem", color: "var(--muted)", textTransform: "uppercase", letterSpacing: ".05em", marginBottom: 6 }}>Win distribution (0–82)</div>
